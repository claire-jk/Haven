...
const SavedPlacesScreen = () => {
  ...
  const [selectedPlace, setSelectedPlace] =
    useState<RelaxMarker | null>(null);
  ...
  const renderItem = ({ item }: { item: RelaxMarker }) => (
    ...
    >
      <View
        style={[
          styles.moodDotContainer,
          { backgroundColor: item.moodColor + '20' },
        ]}
      >
        <View
          style={[
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.detailCard}>
            <View
              style={[
                styles.detailMoodBar,
                {
                  backgroundColor:
                    selectedPlace?.moodColor,
                },
              ]}
            />
